...
Current schema: **save_version 1** (SaveSchema.CURRENT_VERSION).
...
| --- | --- |
| save_version | Nonnegative integer; current version 1 |
...
| settings.controls.bindings | Action strings mapped to arrays of serialized binding strings (max 128 characters each); empty initially; no binding application or rebinding UI |
